import{t as l,a as f,h as p,e as h,S,f as v}from"./main-36634dc1.js";import{h as x}from"./moment-fbc5633a.js";import{T as O}from"./tab-b1a58ad3.js";import{S as P}from"./ScrollEvent-2d368248.js";function F(e){e=e.filter(a=>a.isFinished);const t=Number(x().format("MM")),s=T(e.filter(a=>x(a.createdTime).format("MM")==t)),n=T(e.filter(a=>x(a.createdTime).format("MM")==t-1));document.querySelector("#last-month").textContent=`NT＄${n.revenue_total()}`,document.querySelector("#this-month").textContent=`NT＄${s.revenue_total()}`,document.querySelector("#last-month-rank").innerHTML=A(n.revenue_ranks().splice(0,3)),document.querySelector("#this-month-rank").innerHTML=A(s.revenue_ranks().splice(0,3));const o=T(e).figures(),r=[];Object.keys(o).forEach(a=>r.push({name:a,value:o[a].revenue})),I(r);const d=Object.keys(o).sort((a,u)=>o[a].qty-o[u].qty),c=T(e).revenue_ranks().splice(0,1).join("");j(d,d.map(a=>a!==c?o[a].qty:{value:o[a].qty,itemStyle:{color:"#D1741F"}}))}function I(e){const t=document.querySelector("#revenue-chart");t.style.height="300px";const s=echarts.init(t),n={color:Y,tooltip:{trigger:"item"},legend:{orient:window.innerWidth>768?"veritical":"horizontal",left:"left",type:"scroll",pageButtonGap:16,pageButtonItemGap:8,backgroundColor:"white",borderRadius:8,padding:window.innerWidth>768?16:8},grid:{top:"10%"},series:[{name:"商品銷售額",type:"pie",radius:"95%",label:{show:!1},data:e,emphasis:{itemStyle:{shadowBlur:10,shadowOffsetX:0,shadowColor:"rgba(0, 0, 0, 0.5)"}},top:window.innerWidth>768?null:"21%"}]};n&&s.setOption(n)}function j(e,t){const s=document.querySelector("#qty-chart");s.style.height="400px";const n=echarts.init(s),o={width:"100%",color:["#77BCB7"],title:{left:"center",subtext:"橘色為當前的銷售額冠軍"},tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},grid:{left:"5%",right:"2%",bottom:"10%"},yAxis:{type:"category",data:e,axisTick:{alignWithLabel:!0},axisLabel:{show:!1,margin:20}},xAxis:{type:"value"},series:[{type:"bar",data:t,name:"商品銷售數量",barCategoryGap:"10%"}]};o&&n.setOption(o)}function T(e){const t={};return e.forEach(s=>s.content.forEach(n=>{t[n.product.name]?(t[n.product.name].qty+=n.qty,t[n.product.name].revenue+=n.qty*n.product.price):t[n.product.name]={qty:n.qty,revenue:n.qty*n.product.price}})),{figures:function(){return t},revenue_ranks:function(){return Object.keys(t).sort((s,n)=>t[n].revenue-t[s].revenue).map(s=>[s,t[s]])},revenue_total:function(){return e.reduce((s,n)=>s+(n.total-n.deliveryFee),0)}}}const Y=["#d87c7c","#919e8b","#d7ab82","#6e7074","#61a0a8","#efa18d","#787464","#cc7e63","#724e58","#4b565b"];function A(e){const t={1:"#FFB11B",2:"#BDC0BA",3:"#A36336"};let s="";return e.map(([n,o],r)=>s+=`
    ...
    <input type="text" name="image"
           class="form-control p-2 text-black">`,t.reset()}function X(e){e.preventDefault();const t=e.target.name.value,s=e.target.otherName.value,n=e.target.info.value,o=[...e.target.querySelectorAll('[name="type"]:checked')].map(b=>b.value),r=e.target.size.value,d=e.target.ingredients.value.split(","),c=e.target.price.value,a=[...e.target.querySelectorAll('[name="image"]')].map(b=>b.value).filter(b=>!v(b)),u=e.target.shelfLife.value;if(v(t)||!o.length||v(c)||v(r)||v(u)){l("warning","必填欄位不可空白！");return}else if(isNaN(c)||!Number.isInteger(+c)||c<1){l("warning","價格請填寫大於零的整數");return}else{const b=document.querySelector(".modal-title").textContent;if(b==="新增商品")K({name:t,otherName:s,info:n,type:o,ingredients:d,price:+c,image:a,size:r,shelfLife:u,forSale:!1});else{let D=function(i){return i==="type"||i==="ingredients"?y[i].length!==w[i].length||y[i].some(E=>!w[i].includes(E)):i==="image"?y[i].length!==w[i].length||y[i].some((E,N)=>E!==w[i][N]):y[i]!==w[i]};const B=b.replace(/\D/g,""),w=m.find(i=>i.id==B),y={...w,name:t,otherName:s,info:n,type:o,ingredients:d,price:+c,image:a,size:r,shelfLife:u};Object.keys(y).some(i=>D(i))?te(B,y):l("question","資料沒變哦 (ㆆᴗㆆ)")}}}function K(e){f.post(`${g}/660/products`,e,p).then(t=>{l("success","成功！記得上架商品哦！"),q()}).catch(t=>{h(t)})}function Q(e){let{textContent:t}=e.target;const s=document.querySelectorAll("button.delete");t==="lock"?(s.forEach(n=>n.classList.remove("disabled")),l("success","刪除功能已解鎖"),e.target.textContent="lock_open"):(s.forEach(n=>n.classList.add("disabled")),l("success","刪除功能已上鎖"),e.target.textContent="lock")}function Z({target:e}){if(e.nodeName==="BUTTON"){const s=e.closest(".card").dataset.id,n=m.find(o=>o.id==s);e.classList.contains("status")?S.fire({icon:"warning",title:`確定${e.textContent}？`,text:`商品名稱：${n.name}`,showCancelButton:!0,cancelButtonColor:"#D1741F",cancelButtonText:"取消",confirmButtonColor:"#A37A64",confirmButtonText:"確定",showLoaderOnConfirm:!0,preConfirm:async()=>{try{const o=await f.patch(`${g}/660/products/${s}`,{forSale:!n.forSale},p);l("success",`成功${e.textContent}！`),q()}catch(o){h(o)}}}):e.classList.contains("delete")?S.fire({icon:"warning",title:`確定刪除${n.name}？！`,text:"此操作不可復原，你要確定欸！",showCancelButton:!0,cancelButtonColor:"#D1741F",cancelButtonText:"取消",confirmButtonColor:"#A37A64",confirmButtonText:"確定",showLoaderOnConfirm:!0,preConfirm:async()=>{try{const o=await f.delete(`${g}/660/products/${s}`,p);l("success",`再見，${n.name}！
